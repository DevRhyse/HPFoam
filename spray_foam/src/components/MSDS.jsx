...
export default function MSDS() {
  ...
  return (
    <div className="grid bg-white border-solid border-2 w-10/12 rounded-lg">
      <h1 className='text-4xl justify-center grid mt-5'>Our Product</h1>
      <div>
        <h2 className='text-3xl justify-center grid'>UPC SPF Foams</h2>
        <p className='text-2xl grid w-3/5 mx-auto mt-5'>Energy efficient, reduces insulation time & costs, self flashing, weather resistant, enhances resistance to wind uplift, easy to apply, lightweight, protects against hail damage, available in different densities, seamless, covers geometric shapes & protrusions.</p>
        <span className='text-xl grid justify-center mt-5'><a href="https://foam-direct.com/wp-content/uploads/2021/12/UPC-2.0-Regular-_-High-Lift_092320EA.pdf">For more infomation about UPC 2.0 view or download the MSDS here</a></span>
      </div>
